...
uv run modal volume get cycling-photo-ai-vol experiments/ocr_trocr_4phase/phase4/best/ weights/trocr_bib_4phase/
...
for phase in 1 2 4; do
    ...
    uv run modal volume get cycling-photo-ai-vol \
